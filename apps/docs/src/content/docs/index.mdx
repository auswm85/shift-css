...
template: splash
hero:
  tagline: A modern CSS framework built for perceptual color consistency, automatic theming, and zero specificity conflicts.
  actions:
    - text: Get Started
...
<CardGrid stagger>
  ...
  <Card title="Cascade Layers" icon="layers">
