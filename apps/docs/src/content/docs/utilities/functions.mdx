...
<Demo
  ...
  <p style="opacity: 0.8;">Text contrast, border glow, and font weight all adapt automatically.</p>
</div>`}
/>
...
<Demo
  ...
  <div s-theme="light" style="flex: 1; padding: 1rem; border: 1px solid oklch(0.8 0 0);">
    <div s-dark-aware style="padding: 1rem;">
      ...
      <p style="opacity: 0.7; margin-top: 0.25rem;">Forced light context</p>
    </div>
  </div>
  <div s-theme="dark" style="flex: 1; padding: 1rem; border: 1px solid oklch(0.3 0 0);">
    <div s-dark-aware style="padding: 1rem;">
      <strong>Dark Island</strong>
      <p style="opacity: 0.7; margin-top: 0.25rem;">Forced dark context</p>
    </div>
  </div>
</div>`}
/>
